...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # succeeded with zero errors on api.z.ai/api/coding/paas/v4; 5.3 uses
    # the same base).  Older GLM models (5, 5.1, 5-turbo) are ~202K.
    # Longest-key-first substring matching ensures "glm-5.3" / "glm-5.2"
